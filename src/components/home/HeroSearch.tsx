...
export function HeroSearch() {
  ...
  return (
    ...
    >
      <div className="border-brand-light hover:border-primary focus-within:border-primary-dark focus-visible:ring-brand-light flex w-full items-center rounded-full border-4 bg-white px-8 py-4 text-lg font-bold shadow-lg transition-all focus-within:scale-105 hover:scale-105 focus:outline-none focus-visible:ring-4 sm:w-auto md:min-w-[400px]">
        <Search className="mr-3 h-5 w-5 shrink-0 text-gray-400" />
        <input
          type="text"
          value={query}
          onChange={(e) => setQuery(e.target.value)}
          className="w-full bg-transparent text-gray-900 placeholder:text-gray-400 focus:outline-none text-base font-medium"
