    ...
    <div className="w-full max-w-sm space-y-6">
      <div className="text-center">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Unite a Hogarí como inquilino o agencia
        </p>
      </div>
        ...
        <fieldset className="space-y-2">
          ...
          <div className="flex gap-3">
            {roles.map((role) => (
              <label
                key={role.value}
                className="cursor-pointer has-checked:border-primary has-checked:bg-primary-light flex flex-1 items-center justify-center gap-2 rounded-xl border-2 border-gray-200 px-4 py-3 text-sm font-medium transition-colors"
              >
                <input
                  type="radio"
                  name="role"
